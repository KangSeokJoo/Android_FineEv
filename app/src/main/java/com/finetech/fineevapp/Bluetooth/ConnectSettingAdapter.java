...
class ConnectSettingAdapter extends RecyclerView.Adapter<ConnectSettingAdapter.ItemViewHolder> {
...
//        holder.itemView.setOnClickListener(new View.OnClickListener() {
    ...
    public void clearAlltems(){         // 리사이클러뷰에 표시되는 어댑터 배열을 clear 시킴
        allDeviceName.clear();
    ...
    void addItem(DataList data) {               // 데이터 추가
