...
public class BleConnectDialog extends AppCompatActivity {
    ...
    private com.finetech.fineevapp.Bluetooth.BLEService mBleService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent gattServiceIntent = new Intent(this, com.finetech.fineevapp.Bluetooth.BLEService.class);  //블루투스 서비스 연결 ( background에서도 블루투스 연결이 끊기지 않게 함)
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {                 //브로드캐스트 리시버
            ...
            if (com.finetech.fineevapp.Bluetooth.BLEService.ACTION_GATT_CONNECTED.equals(action)) {                             //기기 상태가 연결됨 일때
                skipIndex = 0;
                mConnected = true;
                mConnecting = false;
...
//                invalidateOptionsMenu();
                ...
                //                clearUI();
            } else if (com.finetech.fineevapp.Bluetooth.BLEService.ACTION_GATT_CONNECTING.equals(action)) {    //기기가 연결중
                mConnecting = true;
                mConnected = false;
//                updateConnectionState(R.string.connecting);
//                invalidateOptionsMenu();

            } else if (com.finetech.fineevapp.Bluetooth.BLEService.ACTION_GATT_SERVICES_DISCOVERED.equals(action)) {  //기기에서 정보를 받아오는중
                // Show all the supported services and characteristics on the user interface.
//                displayGattServices(mBleService.getSupportedGattServices());
            } else if (com.finetech.fineevapp.Bluetooth.BLEService.ACTION_DATA_AVAILABLE.equals(action)) { // 데이터 송수신 가능
//                displayData(intent.getStringExtra(BLEService.EXTRA_DATA));
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            mBleService = ((com.finetech.fineevapp.Bluetooth.BLEService.LocalBinder) service).getService();
...
//                    mConnectionState.setText(resourceId);
    ...
    private static IntentFilter makeGattUpdateIntentFilter() {     //BroadcastReceiver 에 Intent filter 추가
        ...
        intentFilter.addAction(com.finetech.fineevapp.Bluetooth.BLEService.ACTION_GATT_CONNECTED);
        intentFilter.addAction(com.finetech.fineevapp.Bluetooth.BLEService.ACTION_GATT_DISCONNECTED);
        intentFilter.addAction(com.finetech.fineevapp.Bluetooth.BLEService.ACTION_GATT_CONNECTING);
        intentFilter.addAction(com.finetech.fineevapp.Bluetooth.BLEService.ACTION_GATT_BONDED);
        intentFilter.addAction(com.finetech.fineevapp.Bluetooth.BLEService.ACTION_GATT_SERVICES_DISCOVERED);
        intentFilter.addAction(com.finetech.fineevapp.Bluetooth.BLEService.ACTION_DATA_AVAILABLE);
