...
//            });
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(DataList data) {
            ...
            tvMenuDate.setText(data.getDate());
            ...
            tvV.setText(data.getA()+"V");
            tvA.setText(data.getV()+"A");
            tvC.setText(data.getC()+"˚C");

            String[] Battery = data.getCharge().split("\\.");
            bat = Integer.parseInt(Battery[0]);
...
//            item_ConstraintLayout.setOnClickListener(n->{
//                if(a==1){
            if(data.getVisible()==true){
                    item_ConstraintLayout.setBackground(context.getResources().getDrawable(R.drawable.button_back_sky_blue_noncorner));
                    MoreInfoLayout.setVisibility(View.VISIBLE);


                    if(bat < 3 ){
                        ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_white_battery1));
                    }else if(bat < 7){
                        ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_white_battery2));
                    }else if(bat < 12) {
                        ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_white_battery3));
                    }else if(bat < 17) {
                        ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_white_battery4));
                    }else if(bat < 22) {
                        ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_white_battery5));
                    }else if(bat < 27) {
                        ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_white_battery6));
                    }else if(bat < 40) {
                        ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_white_battery7));
                    }else{
                        ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_btgage8));
                    }
                if(data.getCharge().equals("0.00")){
                    ImageBatteryState.setBackground(context.getResources().getDrawable(R.drawable.icon_btgage_back_white));
                }
                            a=0;
                }else{
                    item_ConstraintLayout.setBackground(context.getResources().getDrawable(R.drawable.button_back_white));
                    MoreInfoLayout.setVisibility(GONE);
