...
import com.jinasoft.fineevapp.SetCodeActivity;
...
public class ConnectSettingActivity2 extends AppCompatActivity implements AutoPermissionsListener,ConnectSettingAdapter2.MyRecyclerViewClickListener {
    private ConnectSettingAdapter2 mLeDeviceListAdapter;
                    ...
                    case BluetoothAdapter.STATE_OFF:
                        ...
                        new AlertDialog.Builder(context)
                                ...
                                .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Toast.makeText(ConnectSettingActivity2.this, R.string.error_bluetooth_off, Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
                                })
                                .show();
...
//
    ...
    static ConnectSettingActivity2 conActivity;
...
//        scanWIFI();
        ...
        setCode.setOnClickListener(n -> {
                Intent intent = new Intent(ConnectSettingActivity2.this, SetCodeActivity.class);
...
//                                }
                    ...
                    Toast.makeText(ConnectSettingActivity2.this, "연결된 기기가 없습니다.", Toast.LENGTH_SHORT).show();
                }
                ...
                if (!edtCarName.getText().toString().equals("")) {
                    if (!edtVolt.getText().toString().equals("")) {
                        if (!edtBattery.getText().toString().equals("")) {
                            ...
                            editor.putString("Battery", edtBattery.getText().toString());
                            editor.commit();
                            Intent intent2 = new Intent(ConnectSettingActivity2.this, MainActivity.class);
...
//        mLeDeviceListAdapter.addDevice(null,null);
    ...
    public void init() {
        ...
        mLeDeviceListAdapter = new ConnectSettingAdapter2();
        ...
        edtVolt.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (!edtVolt.getText().toString().equals("")) {
                    if (Integer.parseInt(edtVolt.getText().toString()) > 20) {
                        edtVolt.setText("20");
                        Toast.makeText(ConnectSettingActivity2.this, "전비 설정 범위는 1 ~ 20 입니다. 다시 시도해주세요.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        edtBattery.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (!edtBattery.getText().toString().equals("")) {
                    if (Integer.parseInt(edtBattery.getText().toString()) > 200) {
                        edtBattery.setText("200");
                        Toast.makeText(ConnectSettingActivity2.this, "배터리 용량 범위는 1 ~ 200 입니다. 다시 시도해주세요.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
...
//                    }
            ...
            mHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
//                    Toast.makeText(ConnectSettingActivity.this, "검색 완료", Toast.LENGTH_SHORT).show();
                    Search_Charger.setText("충전기 검색");
                }
            }, 10000);
                                ...
                                public void run() {
                                    ...
                                    for (int i = 0; i < aDeviceAddress.size(); i++) {
                                        if (!allDeviceName.contains(aDeviceName.get(i))) {
                                            ...
                                            ConnectSettingAdapter2.DataList data = new ConnectSettingAdapter2.DataList();
                    ...
                    */
                    ...
                    runOnUiThread(new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (result.getDevice().getName() != null && result.getDevice().getName().contains("FTEV")) {
//                                if (result.getDevice().getName()!=null) {
    ...
    public static ConnectSettingActivity2 getCon() {
        return conActivity;
    }

    public void startActivityConnect(String deviceName, String deviceAddress) {
        Intent intent = new Intent(ConnectSettingActivity2.this, BleConnectDialog.class);
...
//        }
    ...
    public void IntentBleDisConnectDialog() {
        Intent intent = new Intent(ConnectSettingActivity2.this, BleDisConnectDialog.class);
        startActivity(intent);
    }
    ...
    public void scanWIFI() {
        ...
        if (!success) Toast.makeText(ConnectSettingActivity2.this, "Wifi Scan에 실패하였습니다." ,Toast.LENGTH_SHORT).show();
    }
