...
import com.jinasoft.fineevapp.Main.MainAdapter;
import com.jinasoft.fineevapp.Main.MainListActivity;
            ...
            public void afterTextChanged(Editable s) {
                if (!edtBattery.getText().toString().equals("")) {
                    if (Integer.parseInt(edtBattery.getText().toString()) > 200) {
                        ...
                        Toast.makeText(ConnectSettingActivity.this, "배터리 용량 범위는 1 ~ 200 입니다. 다시 시도해주세요.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
